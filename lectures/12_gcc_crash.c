...
/* Here's a "nice" way to calculate the powers of two using nothing but *
 * addition, and since the calculation is done by the compiler, you     *
 * get constants at run time!                                           */
...
struct {
  ...
  po2_lu_entry(twenty_three),
  /*
  po2_lu_entry(twenty_four),
  po2_lu_entry(twenty_five),
  po2_lu_entry(twenty_six),
  po2_lu_entry(twenty_seven),
  po2_lu_entry(twenty_eight),
  po2_lu_entry(twenty_nine),
  po2_lu_entry(thirty),
  po2_lu_entry(thirty_one),
  po2_lu_entry(thirty_two)
  */
};
